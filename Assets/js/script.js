...
$(function () {
  ...
  var timeHr = parseInt(dayjs().format("H")); //this sets up the hour so the function can compare it to the ID's and makes it a number to compare against -DT
...
console.log(this); //this is to check what the "this" is referring to -DT
...
else if(timeId > timeHr){ //if time block is is greater than the current time, the block is the future hour. you dont technically need this -DT
console.log("future"); //since if it isnt any of the first two, it has to be the third but i have it here since i cant get the code to work. -DT
  $(this).addclass("future")
}

});
console.log(timeHr) //this is to check the current time being used -DT
...
save.on("click", function(){
  ...
  console.log(timeSlot); //this confirms the text input is saved in variable timeslot on button press -DT
  console.log(input); //this confirms the input is saved to that specific hour ID on button press -DT 
